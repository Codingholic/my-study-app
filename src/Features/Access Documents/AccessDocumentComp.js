...
import DocumentListIpad from '../DocumentList/DocumentListIpad'
import { useMediaQuery } from 'usehooks-ts'

const AccessDocumentComp = () => {
    const perce = 23;
    const content = 23;
    const matches = useMediaQuery('(min-width: 768px)' && '(max-width: 1024px)')
    return (
        <>
            ...
            {/* <div className='Document_ipad_containerr'>
                <DocumentListIpad />
            </div> */}
{matches ? <DocumentListIpad /> : null}
        </>
    )
}
